...
//@Configuration //Configuration 안쓰면 @Autowired,@Value 못씀
@RequiredArgsConstructor //lombok (final 변수 매개변수 선언 생성자 자동 정의)
...
//        System.out.println("JwtTokenFilter(헤더의 Bearer 뒷부분): " + token);
        ...
        = new UsernamePasswordAuthenticationToken(loginuser, null, List.of(new SimpleGrantedAuthority(loginuser.getRole())));
